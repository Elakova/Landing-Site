...
function initAppCanvas(canvas, type) {
  ...
  const palettes = {
    forex:       [[80,120,200],[60,100,180],[100,140,220],[70,110,190],[90,130,210]],
    equities:    [[80,160,80],[100,180,60],[60,140,100],[140,180,80],[80,200,100]],
    commodities: [[200,160,80],[180,120,60],[160,140,100],[220,180,60],[200,140,80]],
    crypto:      [[140,80,200],[120,60,180],[160,100,220],[130,70,190],[150,90,210]],
    indices:     [[80,160,200],[60,140,180],[100,180,220],[70,150,190],[90,170,210]],
  };
  ...
  function draw(ts) {
    ...
    const labels = { forex: 'EUR/USD | GBP/JPY | USD/JPY', equities: 'AAPL | TSLA | NVDA', commodities: 'XAUUSD | WTIUSD | XAGUSD', crypto: 'BTC | ETH | SOL', indices: 'SPX | NQ100 | DAX' };
